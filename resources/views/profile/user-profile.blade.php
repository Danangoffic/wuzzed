        ...
        <div class="w-full flex flex-wrap">
            <div class="lg:w-1/4">
                <nav class="flex flex-col space-y-2" aria-label="Tabs" role="tablist" data-hs-tabs-vertical="true">
                    <button type="button"
                        class="hs-tab-active:bg-[#F8F4FF] hs-tab-active:text-gray-900 inline-flex items-center px-4 py-3 text-gray-400 rounded-2xl w-full active"
                        ...
                        <svg class="w-4 h-4 me-2 hs-tab-active:text-gray-900 text-gray-400" aria-hidden="true"
                    ...
                    <button type="button"
                        class="hs-tab-active:bg-[#F8F4FF] hs-tab-active:text-gray-900 inline-flex items-center px-4 py-3 text-gray-400 rounded-2xl w-full"
                    ...
                    <button type="button"
                        ...
                        <svg class="w-4 h-4 me-2 hs-tab-active:text-gray-900 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
                    ...
                    <div class="w-full py-2 pl-7">
                        ...
                        <form class="mx-auto">
                            ...
                            <div class="text-right mt-4">
                                <button type="submit"
                                    class="bg-[#FF6905] text-white font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Update
                                    Profile</button>
                            </div>
                        </form>
                    </div>
